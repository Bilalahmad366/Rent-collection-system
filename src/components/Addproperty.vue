<template>
  ...
  <div class="my-6 max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
    <h2 class="text-2xl font-semibold mb-6">Add Property</h2>
    <form @submit.prevent="addprop" class="space-y-4 text-black">
      <!-- Property Image URL -->
      <div>
...
export default {
  ...
  methods :{
   async addprop(){
await axios.post("https://rococo-basbousa-faf12a.netlify.app/.netlify/functions/api/property",{
